...
./bin/jobCommander "$SERVER_NAME" "$PORT_NUMBER" issueJob touch myFile.txt 2>> ./errors/CommandersErrors.log
ls myFile.txt
./bin/jobCommander "$SERVER_NAME" "$PORT_NUMBER" issueJob rm myFile.txt 2>> ./errors/CommandersErrors.log
ls myFile.txt

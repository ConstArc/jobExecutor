...
./bin/jobCommander "$SERVER_NAME" "$PORT_NUMBER" issueJob ./tests/progDelay 1000 2>> ./errors/CommandersErrors.log &
./bin/jobCommander "$SERVER_NAME" "$PORT_NUMBER" issueJob ./tests/progDelay 1000 2>> ./errors/CommandersErrors.log &
./bin/jobCommander "$SERVER_NAME" "$PORT_NUMBER" setConcurrency 4 2>> ./errors/CommandersErrors.log &
./bin/jobCommander "$SERVER_NAME" "$PORT_NUMBER" poll 2>> ./errors/CommandersErrors.log &
./bin/jobCommander "$SERVER_NAME" "$PORT_NUMBER" stop job_4 2>> ./errors/CommandersErrors.log &
./bin/jobCommander "$SERVER_NAME" "$PORT_NUMBER" stop job_5 2>> ./errors/CommandersErrors.log &
./bin/jobCommander "$SERVER_NAME" "$PORT_NUMBER" poll 2>> ./errors/CommandersErrors.log &
